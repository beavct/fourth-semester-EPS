...
void Personagem::setCaractere(char caractere){
...
void Personagem::movimentoLocal(Labirinto Labirinto){
    ...
    if (flag == 2) {
        ...
        this->fixPosition(this->verifyCycle(Labirinto), Labirinto, this->getXProx(), this->getYProx());
        Labirinto.updateLabirinto(Labirinto, ' ', this->getXAtu(), this->getYAtu());
        Labirinto.updateLabirinto(Labirinto, this->caractere, this->getXProx(), this->getYProx());
...
int Personagem::verifyPositionPacman(Labirinto Labirinto){
    if(Labirinto.getElemento(this->getXProx(), this->getYProx()) == '*')
        return 0;
    else if(Labirinto.getElemento(this->getXProx(), this->getYProx()) == '.')
        this->score++;
    else if(Labirinto.getElemento(this->getXProx(), this->getYProx()) == 'F') {
