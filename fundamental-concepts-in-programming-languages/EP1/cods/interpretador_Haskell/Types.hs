...
data ExprS
  ...
  | -- MODIFICAÇÃO
    -- BoolS    { boolS :: String}
    BoolSTrue    { boolS_True :: String}
  |
    BoolSFalse   { boolS_False :: String}
  deriving (Show, Eq)
...
data ExprC
  ...
  | -- MODIFICAÇÃO
    -- BoolC   { boolC :: String}
    BoolCTrue  { boolC_True :: String}
  |
    BoolCFalse  { boolC_False :: String}
  deriving (Show, Eq)
...
data Value
  ...
  | -- MODIFICAÇÃO
    -- BoolV { boolV :: String}
    BoolVTrue  { boolV_True :: String}
  |
    BoolVFalse  { boolV_False :: String}
  deriving (Show, Eq)
